...
public class JsonAdaptedBugTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedBug person = new JsonAdaptedBug(null, VALID_STATE, VALID_DESCRIPTION, VALID_TAGS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedBug person = new JsonAdaptedBug(VALID_NAME, VALID_STATE, null, VALID_TAGS);
