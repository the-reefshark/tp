...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_BUG_DISPLAYED_INDEX);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + STATE_DESC_AMY
    ...
    public void getFilteredBugList_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredBugList().remove(0));
    }
     ...
     */
    private static class JsonKanBugTrackerIoExceptionThrowingStub extends JsonKanBugTrackerStorage {
        private JsonKanBugTrackerIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
